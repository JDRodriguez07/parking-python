...
class OwnerService:
    ...
    def update_owner(self, owner):
        ...
        if owner_with_same_dni and owner_with_same_dni.id_owner != owner.id_owner:
            return False, "Ya existe otro dueñi con ese DNI"

        updated = self.repo.update(owner)

        if not updated:
            return False, "No se pudo actualizar el dueño"

        return True, "Dueño actualizado correctamente"
